 ...
 *  following way:
 *  @p(code)
 *  xs xdc.tools.configuro ... -p "ti.platforms.msp432:MSP432P401R"
 *  @p
 *
 *  In package.bld, the platform instance is selected as in:
 *  @p(code)
 *  Pkg.addExecutable("test", target, "ti.platforms.msp432:MSP432P401R");
 *  @p
 */
...
metaonly module Platform inherits xdc.platform.IPlatform
{
     ...
     *  @p(code)
     *      xs xdc.tools.configuro ... -p ti.platforms.msp432:MSP432P401R:1:20
     *  @p
