...
__extern xdc_Ptr ti_sysbios_xdcruntime_GateThreadSupport_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
